...
@section('content')
                    ...
                    @if (!empty($delivery_terms))
                        @foreach ($delivery_terms as $key => $delivery_term)
                            <tr>
                                ...
                                <td>{{ $delivery_term->status }}</td>
                                <td class="d-flex">
                                    <a href="{{ route('delivery_terms.edit', $delivery_term->id) }}"
                                        class="btn btn-warning btn-sm btn-clean btn-icon" title="Edit details">
                                        <i class="la la-edit"></i>
                                    </a>
                                    {{ html()->form('DELETE', '/delivery_terms/' . $delivery_term->id)->open() }}
    ...
    <div class="modal fade" id="addCertificationModel" tabindex="-1" role="dialog"
        ...
        {{ html()->form('POST', '/delivery_terms')->open() }}
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <div class="col-12">
                            ...
                            <select name="delivery_for" class="form-control" required>
