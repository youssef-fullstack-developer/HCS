            ...
            <table class="table table-bordered table-hover" id="table_invoice_settings">
                <thead>
                    <tr class="text-uppercase">
                        <th>id</th>
                        <th class="pl-7"><span class="text-dark-75">Shade</span></th>
                        <th class="pl-7"><span class="text-dark-75">Parent Sort</span></th>
                        <th class="pl-7"><span class="text-dark-75">Actual Sort</span></th>
                        <th>Action</th>
                    </tr>
                </thead>
                <tbody>
