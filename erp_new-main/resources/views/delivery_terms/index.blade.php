...
@section('content')
    <div class="card card-custom" style="box-shadow: none">
        <div class="card-header flex-wrap border-0 pt-0 pb-0">
            ...
            <div class="card-toolbar">
                <button data-toggle="modal" data-target="#addDeliveryModel"
    ...
    <div class="modal fade" id="addDeliveryModel" tabindex="-1" role="dialog"
        aria-labelledby="addDeliveryModelLabel" aria-hidden="true">
        {{ html()->form('POST', '/deliver_terms')->open() }}
