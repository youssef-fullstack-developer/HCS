                    ...
                    @if (!empty($uom))
                        @foreach ($uom as $key => $u)
                            <tr>
                                ...
                                <td>{{ $u->status }}</td>
                                <td class="d-flex">
                                    <a href="{{ route('invoice_settings.edit', $u->id) }}"
                                        class="btn btn-warning btn-sm btn-clean btn-icon" title="Edit details">
                                        <i class="la la-edit"></i>
                                    </a>
                                    {{ html()->form('DELETE', '/invoice_settings/' . $u->id)->open() }}
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <div class="col-12">
                            ...
                            <input type="text" name="to_meter" class="form-control" id="key" autocomplete="off"
                                placeholder="Enter Meter Conversion Value" value="{{ old('key') }}" required />
                        </div>
                    </div>
