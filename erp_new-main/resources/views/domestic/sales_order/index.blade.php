    ...
    <div class="card card-custom" style="box-shadow: none">
        <div class="card-header flex-wrap border-0 pt-0 pb-0">
            <div class="card-title">
                <h3 class="card-label">
                    Domestic Sales Order List
                </h3>
            </div>
            <div class="card-toolbar">
                <a href="{{route('domestic.sales_order.create')}}"
            ...
            <table class="table table-bordered table-hover" id="table_invoice_settings">
                <thead>
                    <tr class="text-uppercase">
                        ...
                        <th class="pl-7"><span class="text-dark-75">Master Sort No</span></th>
                        <th class="pl-7"><span class="text-dark-75">Buyer Product</span></th>
                        <th class="pl-7"><span class="text-dark-75">Quality</span></th>
                        <th class="pl-7"><span class="text-dark-75">Sort No</span></th>
                        <th class="pl-7"><span class="text-dark-75">Buyer PO</span></th>
