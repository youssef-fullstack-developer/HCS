    ...
    <div class="card card-custom" style="box-shadow: none">
        <div class="card-header flex-wrap border-0 pt-0 pb-0">
            <div class="card-title">
                <h3 class="card-label">
                    Domestic Contract List
                </h3>
            </div>
            <div class="card-toolbar">
                <a href="{{ route('domestic.contract.create') }}" class="btn btn-primary font-weight-bolder mr-2">
            ...
            <table class="table table-bordered table-hover" id="table_invoice_settings">
                <thead>
                    <tr class="text-uppercase">
                        <th>id</th>
                        <th class="pl-7"><span class="text-dark-75">Contract Type Name</span></th>
                        <th class="pl-7"><span class="text-dark-75">Contract Code</span></th>
                        <th>Action</th>
                    </tr>
                </thead>
                <tbody>
