...
@section('content')
    <div class="card card-custom" style="box-shadow: none">
        <div class="card-header flex-wrap border-0 pt-0 pb-0">
            ...
            <div class="card-toolbar">
                <button data-toggle="modal" data-target="#addPackingModel"
            ...
            <table class="table table-bordered table-hover" id="table_invoice_settings">
                <thead>
                    <tr class="text-uppercase">
                        <th>id</th>
                        <th class="pl-7"><span class="text-dark-75">Packing Type</span></th>
    ...
    <div class="modal fade" id="addPackingModel" tabindex="-1" role="dialog"
        aria-labelledby="addPackingModelLabel" aria-hidden="true">
