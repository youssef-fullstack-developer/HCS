            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <div class="col-12">
                            <label>Count:</label>
                            <input type="text" name="count" class="form-control" id="count" autocomplete="off"
                                placeholder="Enter Count" value="{{ old('count') }}" required />
                        </div>
                    </div>
