    ...
    <div class="card card-custom" style="box-shadow: none">
        <div class="card-header flex-wrap border-0 pt-0 pb-0">
            <div class="card-title">
                <h3 class="card-label">
                    Yarn Processing Contract Issue List
                </h3>
            </div>

            <div class="card-toolbar">
                <a href="{{ route('planning.yarn_processing_contract_issue.create') }}" class="btn btn-primary font-weight-bolder mr-2">
            ...
            <table class="table table-bordered table-hover" id="table_invoice_settings">
                <thead>
                    <tr class="text-uppercase">
                        <th>id</th>
                        <th class="pl-7"><span class="text-dark-75">Processing Contract No.</span></th>
                        <th class="pl-7"><span class="text-dark-75">Weaving Contract No.</span></th>
                        <th class="pl-7"><span class="text-dark-75">Processing Contract Date.</span></th>
                        <th class="pl-7"><span class="text-dark-75">Processing Outward No.</span></th>
                        <th class="pl-7"><span class="text-dark-75">Vendor Name</span></th>
                        <th class="pl-7"><span class="text-dark-75">Issuing Yarn</span></th>
                        <th class="pl-7"><span class="text-dark-75">Total Bags</span></th>
                        <th class="pl-7"><span class="text-dark-75">Issued Bags</span></th>
                        <th class="pl-7"><span class="text-dark-75">Balance Bags</span></th>
                        <th class="pl-7"><span class="text-dark-75">Total Cones</span></th>
                        <th class="pl-7"><span class="text-dark-75">Issued Cones</span></th>
                        <th class="pl-7"><span class="text-dark-75">Balance Cones</span></th>
