    ...
    <div class="card card-custom" style="box-shadow: none">
        <div class="card-header flex-wrap border-0 pt-0 pb-0">
            <div class="card-title">
                <h3 class="card-label">
                    Jobwork Process Contract Issue List
                </h3>
            </div>

            <div class="card-toolbar">
                <a href="{{ route('planning.jobwork_process_contract_issue.create') }}"
            ...
            <table class="table table-bordered table-hover" id="table_invoice_settings">
                <thead>
                    <tr class="text-uppercase">
                        ...
                        <th class="pl-7"><span class="text-dark-75">E - Invoice Generate</span></th>
                        <th class="pl-7"><span class="text-dark-75">E - Invoice Cancel</span></th>
                        <th class="pl-7"><span class="text-dark-75">E - Waybill Generate</span></th>
