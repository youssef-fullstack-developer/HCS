    ...
    <div class="card card-custom" style="box-shadow: none">
        <div class="card-header flex-wrap border-0 pt-0 pb-0">
            ...
            <div class="card-toolbar">
                <a href="{{ route('license.create') }}" class="btn btn-primary font-weight-bolder mr-2">
            ...
            <table class="table table-bordered table-hover" id="table_invoice_settings">
                <thead>
                    <tr class="text-uppercase">
                        <th>id</th>
                        <th class="pl-7"><span class="text-dark-75">License No.</span></th>
                        <th class="pl-7"><span class="text-dark-75">License Type</span></th>
                        ...
                        <th class="pl-7"><span class="text-dark-75">License Date</span></th>
