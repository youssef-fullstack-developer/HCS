            ...
            <table class="table table-bordered table-hover" id="table_invoice_settings">
                <thead>
                    <tr class="text-uppercase">
                        ...
                        <th class="pl-7"><span class="text-dark-75">Country Name</span></th>
                        <th class="pl-7"><span class="text-dark-75">Primary Contact</span></th>
                        <th class="pl-7"><span class="text-dark-75">Secondary Contact</span></th>
                        <th class="pl-7"><span class="text-dark-75">Address</span></th>
                        <th class="pl-7"><span class="text-dark-75">Pin Code</span></th>
                        <th class="pl-7"><span class="text-dark-75">Agent Percent</span></th>
